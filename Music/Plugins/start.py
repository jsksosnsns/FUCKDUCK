import asyncio
 ...
 def start_pannel():
     buttons = [
         ...
         [
             InlineKeyboardButton("📚 ​ ", url="https://t.me/dost_hai_sab"),
         ],
         [
             InlineKeyboardButton("🌐 sᴏᴜʀᴄᴇ ", url="https://xxnx.com"),
         ],
     ]
     returns (
 ...
 pstart_markup = InlineKeyboardMarkup(
     [
         [
             InlineKeyboardButton(
                 "➕ ᴍᴇ ʏᴏᴜʀ ​ ", url=f"https://t.me/{BOT_USERNAME}?startgroup=true"),
         ],
         [
             InlineKeyboardButton(text="✨ sᴜᴘᴘᴏʀᴛ​", url=f"https://t.me/{GROUP}"),
             InlineKeyboardButton("✨ s", url=f"https://t.me/{CHANNEL}"),
         ],
         [
             InlineKeyboardButton("📚 ​📚", url="https://t.me/Dost_hai_sab"),
         ],
 ...
 **✨ Welcome {rpk}!
 ...
 To Know All Bot Commands And How It Works With The Press Of A Button » ​!**
 ...
 **Channel Link:** [Visit From Here]({x["channel_url"]})
 ...
 async def settings(_, message: Message):
     ...
     if not _check:
         ...
         await save_assistant(c_id, "assistant", assist)
         volume = 100
     else:
 ...
 async def okaybhai(_, CallbackQuery):
     ...
     await CallbackQuery.edit_message_text(
         text=f"Thanks for adding me to {CallbackQuery.message.chat.title}.\n{BOT_NAME} Is online.\n\nIf you need help or if there is a problem with a bot please join our group or channel.",
         reply_markup=InlineKeyboardMarkup(out[1]),
     )
 ...
 async def start_markup_check(_, CallbackQuery):
     ...
     if command == "USERLIST":
         ...
         if not _playlist:
             ...
             j = 0
             await CallbackQuery.edit_message_text(
                 "Fetching Authorized Users... Please Wait"
             )
